//! Interim principal extraction from `X-Proven-Tenant-Id` / `X-Proven-User-Id` (non-prod).
...
pub struct ProjectsPrincipal {
    pub tenant_id: TenantId,
    pub user_id: UserId,
}

impl ProjectsPrincipal {
...
impl<S> FromRequestParts<S> for ProjectsPrincipal
where
    S: Send + Sync,
{
