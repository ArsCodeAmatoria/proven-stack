...
README treatment: **white** fingerprint on **earthy** `#3F3A32` (`assets/brand/proven-mark.png` / `.svg`). Highlight / emphasis text uses **mustard** `#C9A227` (shields — not a logo ring).
